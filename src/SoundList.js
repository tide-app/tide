    ...
    <div className={`text-left ${className}`}>
      ...
      <div className="list-item-container">
        {tracks.map((track) => (
          ...
          >
            <div className="group hover:bg-secondary hover:text-primary transition duration-150 ease-in-out border border-solid border-secondary p-3 flex items-center">
              <IonIcon
              ...
              <div className="w-6/12 hidden sm:flex flex-row justify-end items-center opacity-50 group-hover:opacity-100 sm:hover:opacity-0">
